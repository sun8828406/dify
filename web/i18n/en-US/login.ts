const translation = {
  ...
  welcome: '👋 Welcome to Suntray, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Suntray Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Suntray',
  invalid: 'The link has expired',
  explore: 'Explore Suntray',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Suntray and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Suntray Enterprise license for your workspace has expired. Please contact your administrator to continue using Suntray.',
