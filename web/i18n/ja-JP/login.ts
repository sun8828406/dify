const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'Suntrayへようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、Suntray Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'Suntrayへのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの Suntray Enterprise ライセンスの有効期限が切れています。Suntrayを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Suntray Enterprise ライセンスが非アクティブです。Suntrayを引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'Suntrayライセンスサーバーへの接続に失敗しました。続けてSuntrayを使用するために管理者に連絡してください。',
}
