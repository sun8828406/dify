const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte Suntray',
    langGeniusAccountTip: 'Votre compte Suntray et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à Suntray pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par Suntray vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de Suntray.',
  ...
  about: {
    ...
    nowAvailable: 'Suntray {{version}} est maintenant disponible.',
    latestAvailable: 'Suntray {{version}} est la dernière version disponible.',
  },
  appMenus: {
