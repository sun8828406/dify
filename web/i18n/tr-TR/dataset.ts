const translation = {
  ...
  intro1: 'Bilgi, Suntray uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Suntray dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
