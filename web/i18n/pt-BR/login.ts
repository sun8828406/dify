const translation = {
  ...
  welcome: 'Bem-vindo ao Suntray, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Suntray, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Suntray',
  invalid: 'O link expirou',
  explore: 'Explorar o Suntray',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Suntray e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Suntray Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Suntray.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Suntray. Entre em contato com o administrador para continuar usando o Suntray.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Suntray Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Suntray.',
}
