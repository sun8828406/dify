const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Suntray ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Suntray و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
