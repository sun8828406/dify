const translation = {
  ...
  welcome: 'Benvenuto su Suntray, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Suntray Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Suntray',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Suntray',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Suntray e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Suntray. Contatta il tuo amministratore per continuare a utilizzare Suntray.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Suntray Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Suntray.',
  licenseInactiveTip: 'La licenza Suntray Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Suntray.',
