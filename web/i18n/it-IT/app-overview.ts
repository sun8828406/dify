const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di Suntray con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di Suntray.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di Suntray Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
