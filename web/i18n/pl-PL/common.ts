const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Suntray',
    langGeniusAccountTip: 'Twoje konto Suntray i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Suntray, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Suntray pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Suntray.',
  ...
  about: {
    ...
    nowAvailable: 'Suntray {{version}} jest teraz dostępny.',
    latestAvailable: 'Suntray {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
