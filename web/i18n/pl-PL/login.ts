const translation = {
  ...
  welcome: 'Witaj w Suntray, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Suntray, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Suntray',
  invalid: 'Link wygasł',
  explore: 'Odkryj Suntray',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Suntray, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Suntray Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Suntray.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Suntray. Skontaktuj się z administratorem, aby kontynuować korzystanie z Suntray.',
  licenseInactiveTip: 'Licencja Suntray Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Suntray.',
}
