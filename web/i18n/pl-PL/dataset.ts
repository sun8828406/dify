const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Suntray ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Suntray i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
