const translation = {
  ...
  welcome: 'Dobrodošli v Suntray, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Suntray Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Suntray',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Suntray',
  ...
  licenseExpiredTip: 'Licenca za Suntray Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Suntray, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Suntray, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Suntray ni uspela. Če želite še naprej uporabljati Suntray, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Suntray Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Suntray, se obrnite na skrbnika.',
}
