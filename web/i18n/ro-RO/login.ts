const translation = {
  ...
  welcome: 'Bine ai venit la Suntray, te rugăm să te autentifici pentru a continua.',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Suntray și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Suntray. Contactați administratorul pentru a continua să utilizați Suntray.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Suntray Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Suntray.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Suntray Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Suntray.',
}
