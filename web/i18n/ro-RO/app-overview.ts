const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Suntray cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Suntray.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Suntray Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
