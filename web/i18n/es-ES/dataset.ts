const translation = {
  ...
  didYouKnow: '¿Sabías?',
  intro1: 'El Conocimiento se puede integrar en la aplicación Suntray ',
  ...
  externalAPIPanelDescription: 'La API de conocimiento externo se utiliza para conectarse a una base de conocimiento fuera de Suntray y recuperar conocimiento de esa base de conocimiento.',
